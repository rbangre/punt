    ...
    static async getConfiguration(validate = true, options = {}) {
        ...
        for (let path of paths) {
            ...
            if (await (0, fs_extra_1.pathExists)(path)) {
                ...
                return new Configuration_1.Configuration(Utils_1.Utils.merge({}, esmConfigOptions, tmp, options, env), validate);
            }
        }
        if (Utils_1.Utils.hasObjectKeys(env)) {
            return new Configuration_1.Configuration(Utils_1.Utils.merge({}, options, env), validate);
        }
